...
public void createCourier() {
    ...
    ValidatableResponse responseCreateCourier = courierSteps.createCourier(createCourier);
    LoginCourier courier = LoginCourier.from(createCourier);
    courierId = courierSteps.loginCourier(courier).extract().path("id");
    pulls.checkCreateOk(responseCreateCourier);
}
